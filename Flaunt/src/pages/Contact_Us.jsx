    ...
    <div style={{height:'650px'}}>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2 style={{color: '#fc2779'}}>Get In Touch</h2>
          <p><strong>customersupport@flaunt.com</strong></p>
          <p>We are here to answer all of your queries. We try to get back to everyone's query in a day but max it might take upto 72Hrs.</p>
        </div>
      </div>
    </section>
    </div>
